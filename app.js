...
var appen = function() {
	...
	for (var i = 0; i < newArr.length; i++) {
		$( "<tr><td>"+ newArr[i].middle+"</td><td>"+newArr[i].last+"</td><td>"+newArr[i].sky+"</td><td>"+newArr[i].human+"</td><td>"+newArr[i].floor+"</td><td>"+newArr[i].out+"</td><td>"+newArr[i].total+"</td><td>"+newArr[i].three+"</td><td>"+newArr[i].threeScore+"</td></tr>" ).appendTo( "#table" );
	}
};
